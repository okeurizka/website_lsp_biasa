...
@section('content')
    ...
    <div class="pt-20 pb-20 min-h-screen relative bg-cover bg-center"
        ...
        <div class="relative flex justify-center mb-6">
            <img src="{{ asset('images/logo-fix.png') }}" class="w-32 drop-shadow-2xl animate-[fadeIn_.8s_ease-out]">
        </div>

        <!-- Card Form -->
        <div
            class="relative max-w-lg mx-auto bg-white/90 backdrop-blur-xl p-10 
