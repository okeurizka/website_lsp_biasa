...
<style>
  ...
  /* Glow */
  .glow { text-shadow: 0 0 10px rgba(212,175,55,0.35); }
  ...
  .animate-logo-hero { animation: slideLeftToRight 1.2s ease-out forwards; }
  ...
  .animate-title-hero { animation: riseUp 1s ease-out forwards; animation-delay: .3s; opacity: 0; }
  .animate-desc { animation: riseUp 1s ease-out forwards; animation-delay: .7s; opacity: 0; }

  /* Scroll reveal */
  .scroll-animate { opacity: 0; transform: translateY(18px); transition: all .9s ease; }
...
<body class="bg-white">
  ...
  <section class="relative w-full h-screen flex items-center justify-center text-center text-white">
    <img src="{{ asset('images/smkpws.png') }}" class="absolute inset-0 w-full h-full object-cover brightness-[.6] blur-[1px]" alt="hero-bg">
    ...
    <div class="relative z-10 max-w-2xl px-6">
      ...
      <p class="text-lg text-gray-200 animate-desc">Mewujudkan peserta didik kompeten, profesional, dan siap bersaing di dunia kerja sesuai standar industri.</p>
    </div>
  </section>
  ...
  <section class="py-14 text-center">
    ...
    <p class="text-gray-600 mt-4 max-w-2xl mx-auto scroll-animate">Komite dan pembina bekerja sama dengan Dunia Usaha / Dunia Industri untuk menjaga mutu sertifikasi.</p>
  </section>
...
<section class="px-6 pb-12">
    <div class="max-w-6xl mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-10">
        ...
        <div class="text-center">
            <img src="{{ asset('images/tutwuri.png') }}" class="w-36 h-36 rounded-full object-cover mx-auto shadow-md border-4 border-[#B58A3A]" />
        ...
        <!-- PROFILE 2 -->
        <div class="text-center">
            <img src="{{ asset('images/jatim.png') }}" class="w-36 h-36 rounded-full object-cover mx-auto shadow-md border-4 border-[#B58A3A]" />
        ...
        <!-- PROFILE 3 -->
        <div class="text-center">
            <img src="{{ asset('images/anon.png') }}" class="w-36 h-36 rounded-full object-cover mx-auto shadow-md border-4 border-[#B58A3A]" />
...
<section class="py-12 relative">
    ...
    <div class="relative w-full flex items-center justify-center">
        ...
        <!-- LEFT ARROW -->
        <button id="prevBtn" class="absolute left-5 z-10 bg-gray-800 text-white p-3 rounded-full shadow-lg hover:bg-gray-600 transition">
            &#10094;
        </button>

        <!-- Slider -->
        <div id="slider" class="flex gap-10 overflow-hidden select-none transition-transform duration-500">
            @for ($i = 1; $i <= 8; $i++)
            <div class="mitra-slide flex-shrink-0 w-48 h-48 bg-white rounded-2xl shadow-xl flex flex-col items-center justify-center transition-all duration-500">
                <img src="{{ asset('images/logo-fix.png') }}" class="w-24 h-24 object-contain opacity-90 mb-3">
        ...
        <!-- RIGHT ARROW -->
        <button id="nextBtn" class="absolute right-5 z-10 bg-gray-800 text-white p-3 rounded-full shadow-lg hover:bg-gray-600 transition">
            &#10095;
        </button>
    </div>
</section>
